...
const Bussiness = () => {
  return (
    <section className="  mx-auto bg-gray-100 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto ">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20 ">
              <h2 className="mb-3 text-3xl font-bold leading-[1.2] text-dark dark:text-white sm:text-4xl md:text-[40px] text-green-600">
                Our Services
              </h2>
              <p className="text-base text-body-color dark:text-dark-6">
                Create an automated Gerbera Flower counting system with drones
                and cameras, addressing obstacles, and minimizing manual labor.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="-mx-4 flex flex-wrap ">
          <ServiceCard
            title="RealTime Counting"
            details=" Achieve accurate real-time counting ."
            icon={
              <svg
                width="36"
                height="36"
          ...
          <ServiceCard
            ...
            details=" Reduce manual labor and errors in floriculture."
            icon={
              <svg
                width="36"
                height="36"
          ...
          />
          <ServiceCard
            title="UAV based Approach"
            details=" Automate flower counting using drones and cameras."
            icon={
              <svg
                width="36"
                height="36"
  ...
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3 ">
        <div className="mb-9 rounded-[20px] bg-green-100 p-10 shadow-2 hover:shadow-lg hover:scale-105 ease-in-out duration-300 dark:bg-dark-2 md:px-7 xl:px-10 ">
          <div
